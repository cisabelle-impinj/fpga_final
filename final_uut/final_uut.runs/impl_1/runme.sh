...
HD_PWD='G:/ucsdExtension/Fgpa1/final/final_uut/final_uut.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log disp_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source disp_ctrl.tcl -notrace
