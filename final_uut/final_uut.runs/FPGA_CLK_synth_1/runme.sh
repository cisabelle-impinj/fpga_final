...
HD_PWD='G:/ucsdExtension/Fgpa1/final/final_uut/final_uut.runs/FPGA_CLK_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_CLK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_CLK.tcl
