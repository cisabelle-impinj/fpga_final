...
HD_PWD='G:/ucsdExtension/Fgpa1/final/final_uut/final_uut.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log disp_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source disp_ctrl.tcl
