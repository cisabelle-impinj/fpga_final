...
#
# Generated by export_simulation on Sat Jun 08 19:13:47 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './FPGA_CLK.sh' script.

./FPGA_CLK.sh -reset_run
...
./FPGA_CLK.sh -noclean_files

For more information on the script, please type './FPGA_CLK.sh -help'.
